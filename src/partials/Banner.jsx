...
function Banner() {
  ...
  const liteLink =
    template === 'laravel'
      ? 'https://github.com/OLGTX303?tab=repositories'
      : 'https://github.com/OLGTX303?tab=repositories';
